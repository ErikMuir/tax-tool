...
describe("UserInterface", () => {
  ...
  describe("confirm", () => {
    it("should throw error when called after dispose", () => {
      ...
      assert.rejects(
        async () => await ui.confirm("Test?", true),
        { message: "UserInterface has been disposed." }
      );
    });
  ...
  describe("menu", () => {
    it("should throw error when called after dispose", () => {
      ...
      assert.rejects(
        async () => await ui.menu("Choose:", { a: "Option A", b: "Option B" }),
        { message: "UserInterface has been disposed." }
      );
    });

    it("should write menu message and all options", async () => {
